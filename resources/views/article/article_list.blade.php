            ...
            <div class="article-abstract shadow clear">
                ...
                <div class="title-abstract-picture">
                    <div class="title-abstract inline-block">
                        <div class="title">Linux文件存储之inode、硬链接、软链接</div>
                        <div class="abstract">需求：爬取 DB 网站所有的商品 ID及图片 方案：使用 Nightmare 踩坑公司电脑安装的 win10 系统，写好的 脚本代码带回家在自己的笔记本（Ubuntu18.04系统）上执行无结果且无报错，Google 半个下午未找到合适答案，但大致可以定位问题原因：Nightmare 未检测到图形接口；出去转了一下午，晚上抱着试试的心态查了下笔11记本的驱动果然没有安出去转了一下午，晚上抱着试试的心态查了下笔11记本的驱动果然没有安</div>
                    </div>
